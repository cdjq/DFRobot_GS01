 ...
 *@details  This code detects the position, score of faces, and gestures along with their scores. It interacts with the DFRobot GS01 sensor to perform face and gesture detection and display the results.
...
// Create an instance of DFRobot_GS01_I2C with the specified device ID
